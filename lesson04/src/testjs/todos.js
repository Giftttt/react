...
// console.log(typeof schedules[0].todos[0].time)
// console.log(typeof schedules[0].todos[0].text)
// console.log(typeof schedules[0].todos[0].checked)
